...
contract DogeBit is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Doge Bit';
    string  private constant _SYMBOL = 'DBIT';
    ...
    uint256 private _tTotal = 1070000 * _DECIMALFACTOR;
